 ...
 */
goog.provide('huiyan.flexselect');
goog.require('jQuery');
goog.require('huiyan.base');
goog.require('huiyan.LiquidMetal');
...
(function($) {
  ...
  $.extend($.flexselect.prototype, {
    ...
    renderControls: function() {
      var selected = this.select.children("option:selected"), oIframe;
    ...
    filterResults: function() {
      ...
      $.each(this.cache, function() {
        this.score = huiyan.LiquidMetal.score(this.name, abbreviation);
    ...
    renderDropdown: function() {
      ...
      var list = this.dropdownList.html(""), self = this;
      $.each(this.results, function() {
        // list.append($("<li/>").html(this.name + " <small>[" + Math.round(this.score*100)/100 + "]</small>"));

        list.append($("<li/>").html(this.name));
      });
      this.dropdown.show(0, goog.bind(this.selectLayer.setHeight, this.selectLayer));
    },
    ...
    pickSelected: function() {
      ...
      if (selected) {
        ...
        this.picked = true;
        if( goog.typeOf( this.settings.onselected ) === 'function' ){
